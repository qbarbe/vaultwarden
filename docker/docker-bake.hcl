...
variable "CONTAINER_REGISTRIES" {
  default = "ghcr.io/qbarbe/vaultwarden,docker.io/qbarbe/vaultwarden"
}
...
function "labels" {
  ...
  result = {
    ...
    "org.opencontainers.image.documentation" = "https://github.com/qbarbe/vaultwarden/wiki"
    "org.opencontainers.image.url" = "https://github.com/qbarbe/vaultwarden"
