...
LABEL_ARGS=(
    ...
    --label org.opencontainers.image.documentation="https://github.com/qbarbe/vaultwarden/wiki"
    --label org.opencontainers.image.url="https://github.com/qbarbe/vaultwarden"
